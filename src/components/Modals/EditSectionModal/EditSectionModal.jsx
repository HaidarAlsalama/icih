...
export default function EditSectionModal({ title, children, open = false, close }) {
  const ref = useRef();
        ...
        >
          <div className="relative w-full max-w-2xl  ">
            ...
            >
              ...
              <div className="body-modal min-h-60 flex flex-col gap-2 px-4 md:px-5 p-1 md:p-2 space-y-4 overflow-auto">
                {children}
              </div>
