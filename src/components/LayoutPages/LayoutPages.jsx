...
import { _lg_size, _md_size } from "../../configs/layoutSizes";
  ...
  return (
    <section className="flex duration-150">
      ...
      >
        ...
        <div
          className={`flex flex-col gap-3 md:my-4 bg-slate-200 dark:bg-gray-900 w-full !h-full_ rounded-lg p-2 md:p-4 overflow-x-hidden duration-150`}
        >
          <BreadcrumbContext />
          {children}
        </div>
